...
ActiveRecord::Schema.define(:version => 20140908064748) do
  ...
  add_index "companys_info_snippets", ["info_snippet_id", "company_id"], :name => "companys_info_snippets_info_snippet_id_company_id_key", :unique => true
  ...
  create_table "info_snippets", :force => true do |t|
    ...
    t.date     "event_date"
    t.text     "subject"
    t.boolean  "timeline_snippet", :default => false
  end
